...
# ================= 사용자 설정 =================
YAML_PATH = "~/KORA_K3/src/kora_k3/src/path_planning/columbia.yaml"     # 예: "columbia.yaml"
PGM_PATH  = "~/KORA_K3/src/kora_k3/src/path_planning/columbia.pgm"      # 예: "columbia.pgm"
